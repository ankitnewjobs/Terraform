...
This Terraform code block defines **local values** using the `locals` construct. Local values help **simplify complex expressions**, **avoid repetition**, and **make your configuration more readable and maintainable**.
